...
struct LinkedListQuizView: View {
    ...
    @State private var questions: [QuizQuestion] = QuizData.linkedListQuestions
            ...
            ZStack {
                ...
                if isLoading {
                    VStack(spacing: 20) {
                        ...
                        Text("Structuring 5 fresh questions based on Linked List concepts")
                            .font(.subheadline)
    ...
    private func loadAIQuiz() async {
        ...
        do {
            let aiQuestions = try await AIQuizGenerator.shared.generateQuiz(
                ...
                context: "Nodes, data and next pointers, singly linked lists, doubly linked lists, circular linked lists, list head and tail, time complexity of insertion/deletion/searching, and reversing a linked list."
            )
