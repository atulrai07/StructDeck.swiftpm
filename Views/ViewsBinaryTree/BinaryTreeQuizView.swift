...
struct BinaryTreeQuizView: View {
    ...
    @State private var questions: [QuizQuestion] = QuizData.binaryTreeQuestions
            ...
            ZStack {
                ...
                if isLoading {
                    VStack(spacing: 20) {
                        ...
                        Text("Structuring 5 fresh questions based on Binary Tree concepts")
                            .font(.subheadline)
    ...
    private func loadAIQuiz() async {
        ...
        do {
            let aiQuestions = try await AIQuizGenerator.shared.generateQuiz(
                ...
                context: "Nodes, root, parent, child, and leaf nodes, binary search trees (BST), tree traversals (In-order, Pre-order, Post-order), tree height and balance, and time complexity of search/insert operations."
            )
