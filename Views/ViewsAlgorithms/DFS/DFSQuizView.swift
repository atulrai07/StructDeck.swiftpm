...
struct DFSQuizView: View {
    ...
    // LOAD DATA
    @State private var questions: [QuizQuestion] = QuizData.dfsQuestions
            ...
            ZStack {
                ...
                if isLoading {
                    VStack(spacing: 20) {
                        ...
                        Text("Structuring 5 fresh questions based on DFS concepts")
                            .font(.subheadline)
    ...
    private func loadAIQuiz() async {
        ...
        do {
            let aiQuestions = try await AIQuizGenerator.shared.generateQuiz(
                ...
                context: "Recursive exploration, stack-based (or call stack) execution, back-tracking, visited set to prevent cycles, connected components, cycle detection, and time/space complexity (O(V+E))."
            )
