...
struct DijkstraTheoryCardsView: View {
    ...
    // LOAD DIJKSTRA DATA
    let cards: [TheoryCard] = TheoryData.dijkstraCards
    ...
    var body: some View {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                LazyVStack(spacing: 0) {
                    ForEach(cards) { card in
                        DijkstraTheoryCardCell(card: card)
        ...
        .toolbar {
            ...
            ToolbarItem(placement: .topBarTrailing) {
                ...
                .accessibilityHint("Double tap to open the interactive Dijkstra visualizer.")
            }
        }
...
struct DijkstraTheoryCardCell: View {
    let card: TheoryCard
    ...
    var body: some View {
        VStack(spacing: 40) {
            ...
            Image(systemName: card.iconName)
                ...
                .foregroundStyle(card.isBridge ? .orange : .yellow)
            ...
            if card.isBridge {
                NavigationLink(destination: DijkstraQuizView()) {
                    HStack {
                        Text("Take the Quiz")
                            .font(.headline)
