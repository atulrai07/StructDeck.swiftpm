...
struct DijkstraQuizView: View {
    ...
    // LOAD DATA
    @State private var questions: [QuizQuestion] = QuizData.dijkstraQuestions
            ...
            ZStack {
                ...
                if isLoading {
                    VStack(spacing: 20) {
                        ...
                        Text("Structuring 5 fresh questions based on Dijkstra's concepts")
                            .font(.subheadline)
    ...
    private func loadAIQuiz() async {
        ...
        do {
            let aiQuestions = try await AIQuizGenerator.shared.generateQuiz(
                ...
                context: "Shortest path in weighted graph, greedy algorithm approach, priority queue optimization, source node distance array, negative weight limitation, and relaxed edges."
            )
